...
public interface IPartnerService {
    ...
    CreatePartnerResponse updatePartner(Long id, UpdatePartnerDTO updatePartnerDTO) throws DataNotFoundException;
...
//
    ...
    void updatePartnerStatus(Long partyId, Boolean isDeleted) throws DataNotFoundException;
