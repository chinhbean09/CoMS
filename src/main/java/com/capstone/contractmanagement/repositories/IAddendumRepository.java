...
//    Page<Addendum> findByContractUserIdAndKeywordAndStatusIn(@Param("userId") Long userId, @Param("keyword") String keyword, @Param("statuses") List<AddendumStatus> statuses, Pageable pageable);
    ...
    Page<Addendum> findByContractUserId(Long userId, List<Long> addendumTypeIds, Pageable pageable);
...
//             OR LOWER(a.title) LIKE LOWER(CONCAT('%', :keyword, '%')))
//    """)
//    Page<Addendum> findByContractUserIdAndKeyword(@Param("userId") Long userId, @Param("keyword") String keyword, @Param("addendumTypeIds") List<Long> addendumTypeIds, Pageable pageable);
...
//        AND a.status IN :statuses
//    """)
//    Page<Addendum> findByContractUserIdAndStatusIn(@Param("userId") Long userId, @Param("statuses") List<AddendumStatus> statuses, @Param("addendumTypeIds") List<Long> addendumTypeIds, Pageable pageable);
